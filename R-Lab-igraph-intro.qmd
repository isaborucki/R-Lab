...
::: notes
**Sprecher*innen-Notizen:**

- *Degree*: Hervorheben, dass ein "Local hero" viele Verbindungen innerhalb einer Subgruppe hat — aber diese Verbindungen sind oft redundant (hohe Dichte innerhalb der Subgruppe).
- *Closeness*: Erklärung anhand kurzer Pfadlängen; geeignet, um zu zeigen, wer schnell Informationen zu allen anderen senden/erhalten kann.
- *Betweenness*: Gut für die Diskussion über Brückenfunktion zwischen Gruppen; wenige Verbindungen, hohe strategische Bedeutung.
:::
